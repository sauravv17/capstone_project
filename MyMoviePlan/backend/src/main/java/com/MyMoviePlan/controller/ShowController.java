...
public class ShowController {
    ...
    private final ShowRepository show = null;
    private final MovieShowsRepository movieShow = null;
    private final MovieRepository movie = null;
    private final UserService service = new UserService();
    private final BookingRepository booking = null;
