export class GlobalConstants {
  ...
  public static SHOW_NAMES: string[] = [
    'Morning Show',
    'Matinee',
    'First Show',
    'Second Show',
  ...
  public static ALL_GENERS: string[] = [
    'Comedy',
    'Romance',
    'Action',
    'Drama',
  ...
  public static ALL_LANGUAGES: string[] = [
    'English',
    'Hindi',
    'Telugu',
    'Kanada',
  ...
  public static ROOT_URL = 'localhost:8081/';
